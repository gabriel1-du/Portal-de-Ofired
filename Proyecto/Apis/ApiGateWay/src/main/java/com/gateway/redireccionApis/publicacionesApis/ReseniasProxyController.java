...
public class ReseniasProxyController {
    ...
    @Value("${services.resenias.base-url}")
    private String reseniasBaseUrl;

    @Value("${services.resenias.base-path}")
    private String reseniasBasePath;

    @RequestMapping(value = {"", "/**"}, method = {RequestMethod.GET})
    public ResponseEntity<?> proxyReseniasPublic(HttpServletRequest request,
    ...
    public ResponseEntity<?> proxyReseniasSecure(HttpServletRequest request,
    ...
    private ResponseEntity<?> handleProxy(HttpServletRequest request, String body, HttpHeaders headers) {
        ...
        System.out.println("RESENIA targetUrl: " + targetUri + "  METHOD: " + method);
        ...
        if (authHeaderForUserId != null && authHeaderForUserId.startsWith("Bearer ")) {
            try {
                ...
                if (userId != null) {
                    ...
                    System.out.println("-> Propagando cabecera X-User-ID: " + userId + " al servicio de reseñas.");
                }
            } catch (Exception e) {
